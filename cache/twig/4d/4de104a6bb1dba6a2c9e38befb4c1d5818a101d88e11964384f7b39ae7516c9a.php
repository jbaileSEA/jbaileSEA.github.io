...
class __TwigTemplate_d828e85bf9f00cea1ac3adc2c11336bc829ac6f27e4190af20208f8b52ff079f extends Twig_Template
{
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["latest"]) {
                ...
                <td class=\"triple page-title\">
                    ...
                    echo "\"><i class=\"fa fa-fw fa-file-text-o\"></i></a> <a href=\"";
...
";
    ...
    {
        return array (  75 => 18,  70 => 15,  58 => 12,  46 => 11,  42 => 9,  37 => 8,  32 => 6,  25 => 4,  21 => 2,  19 => 1,);
    }
    ...
    <div id=\"latest\">
        ...
        {% for latest in admin.latestPages if admin.latestPages %}
            <tr>
                <td class=\"triple page-title\">
                    <a href=\"{{ base_url_simple }}/{{ latest.route|trim('/') }}\"><i class=\"fa fa-fw fa-file-text-o\"></i></a> <a href=\"{{ base_url }}/pages/{{ latest.route|trim('/') }}\">{{ latest.title|e }}</a></td>
...
{% endif %}
", "partials/dashboard-pages.html.twig", "/Users/jon/Portfolio/user/plugins/admin-power-tools/admin/templates/partials/dashboard-pages.html.twig");
    }
}
