...
return [
    ...
    'timestamp' => 1547163349,
    'checksum' => '754b1424ce26bbb95ef4bd3af9c32352',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/tinyseo' => [
                'file' => 'user/plugins/tinyseo/blueprints.yaml',
                'modified' => 1546372141
            ],
            'plugins/random' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.tinyseo.enabled' => [
                ...
                'name' => 'plugins.tinyseo.enabled',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.meta_robots' => [
                'type' => 'checkboxes',
                ...
                'use' => 'keys',
                'name' => 'plugins.tinyseo.meta_robots',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.robots_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.robots_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.description_length' => [
                'type' => 'range',
                ...
                'name' => 'plugins.tinyseo.description_length',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.description_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.description_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.truncate_break' => [
                'type' => 'select',
                'size' => 'large',
                ...
                'name' => 'plugins.tinyseo.truncate_break',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.backup_image' => [
                'type' => 'filepicker',
                'size' => 'large',
                ...
                'name' => 'plugins.tinyseo.backup_image',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.ogimage_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.ogimage_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.site_title' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'PLUGIN_TINYSEO.SITE_TITLE',
                'config-default@' => 'site.title',
                'name' => 'plugins.tinyseo.site_title',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.title_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.title_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.twitterid' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Twitter ID',
                'name' => 'plugins.tinyseo.twitterid',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.twitter_card_type' => [
                'type' => 'select',
                'size' => 'large',
                ...
                'name' => 'plugins.tinyseo.twitter_card_type',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.twitter_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.twitter_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.facebookid' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Facebook App ID',
                'name' => 'plugins.tinyseo.facebookid',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.facebook_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.tinyseo.facebook_section',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.content' => [
                'type' => 'tab',
                'name' => 'plugins.tinyseo.content',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.images' => [
                'type' => 'file',
                ...
                'name' => 'plugins.tinyseo.images',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.medias' => [
                'type' => 'tab',
                'name' => 'plugins.tinyseo.medias',
                'validation' => 'strict'
            ],
            'plugins.tinyseo.tabs' => [
                'type' => 'tabs',
                'active' => 1,
                'name' => 'plugins.tinyseo.tabs',
                'validation' => 'strict'
            ],
            'plugins.random' => [
                'type' => '_root',
            ...
            'plugins.editor.section' => [
                'type' => 'section',
                'name' => 'plugins.editor.section',
                'validation' => 'strict'
            ],
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'tinyseo' => [
                    'tabs' => 'plugins.tinyseo.tabs',
                    'content' => 'plugins.tinyseo.content',
                    'enabled' => 'plugins.tinyseo.enabled',
                    'robots_section' => 'plugins.tinyseo.robots_section',
                    'meta_robots' => 'plugins.tinyseo.meta_robots',
                    'description_section' => 'plugins.tinyseo.description_section',
                    'description_length' => 'plugins.tinyseo.description_length',
                    'truncate_break' => 'plugins.tinyseo.truncate_break',
                    'ogimage_section' => 'plugins.tinyseo.ogimage_section',
                    'backup_image' => 'plugins.tinyseo.backup_image',
                    'title_section' => 'plugins.tinyseo.title_section',
                    'site_title' => 'plugins.tinyseo.site_title',
                    'twitter_section' => 'plugins.tinyseo.twitter_section',
                    'twitterid' => 'plugins.tinyseo.twitterid',
                    'twitter_card_type' => 'plugins.tinyseo.twitter_card_type',
                    'facebook_section' => 'plugins.tinyseo.facebook_section',
                    'facebookid' => 'plugins.tinyseo.facebookid',
                    'medias' => 'plugins.tinyseo.medias',
                    'images' => 'plugins.tinyseo.images'
                ],
                'random' => [
                ...
                'editor' => [
                    ...
                    'section' => 'plugins.editor.section',
